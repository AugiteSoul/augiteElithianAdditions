...
function build(directory, config, parameters, level, seed)
  ...
  -- config.primaryAbility.chargeTime = valueOrRandom(parameters.primaryAbility.chargeTime, seed, config.primaryAbility.chargeTime)
  -- config.primaryAbility.cooldownTime = valueOrRandom(parameters.primaryAbility.cooldownTime, seed, config.primaryAbility.cooldownTime)
  ...
  if config.primaryAbility.projectileParameters then
	...
	config.primaryAbility.chargeTime = valueOrRandom(parameters.primaryAbility.chargeTime, seed, "chargeTime")
	config.primaryAbility.cooldownTime = valueOrRandom(parameters.primaryAbility.cooldownTime, seed, "cooldownTime")
  ...
  if config.fireSounds then
    construct(config, "animationCustom", "sounds", "fire", "chargeLoop", "discharge")
