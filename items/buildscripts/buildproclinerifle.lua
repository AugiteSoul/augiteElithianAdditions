...
function build(directory, config, parameters, level, seed)
  ...
  config.primaryAbility.chargeTime = randomInRange(config.primaryAbility.chargeTime, seed, "chargeTime")
  config.primaryAbility.cooldownTime = randomInRange(config.primaryAbility.cooldownTime, seed, "cooldownTime")
